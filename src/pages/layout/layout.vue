    ...
    <div id="layout">
        ...
        <div class="footer-wrapper">
	        <div id="bottomBar" class="flex flex-h" v-if="$route.meta.showBottomTab">
	            <router-link to="/home" tag="div" class="bottomBar-item col">
                    <p class="icon">
                        <i class="iconfont icon-shouye1"></i>
                    </p>
	            	<p class="txt">首页</p>
	            </router-link>
	            <router-link to="/recharge" tag="div" class="bottomBar-item col">
                    <p class="icon">
                        <i class="iconfont icon-dianpu"></i>
                    </p>
	                <p class="txt">商城</p>
	            </router-link>
	            <router-link to="/my" tag="div" class="bottomBar-item col">
                    <p class="icon">
