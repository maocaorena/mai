<template>
    <div id="receiveAddress_add" class="wrapper" :data="loginstate">
        <div class="content">
            <div class="add-item">
                <p class="add-tip">
                    收件人姓名
        ...
        methods: {
            ...
            save() {
                if (this.addrDetail.consignee.length == 0) {
                    ...
                    let _params = {};
                    if (this.$route.query.addrid) {
                        this.addrDetail.userId = this.userId;
            ...
            getAddrById() {
                ...
                this.api.getB({
                    ...
                    if (res.data.successed) {
                        this.addrDetail = res.data.returnValue;
                        this.addrCity = res.data.returnValue.province + res.data.returnValue.city + res.data.returnValue.region;
                    }
                }).catch(() => {
                    Indicator.close();
                })
